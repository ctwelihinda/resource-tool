 ...
 * @author peter
 */
public class AddParentResource extends HttpServlet {
    ...
    // ######### AUTHENTICATION ###############
        ...
        try
        {
            ...
            else
            {
                ...
                String parent_rnumber = request.getParameter("parent_rnumber");
                if (!parent_rnumber.startsWith("R"))
                { parent_rnumber = "R" + parent_rnumber; }
                Resource parent = ResourceLoader.loadByRNumber(parent_rnumber);

                boolean result = false;

                if (
                        (child_id != null) &&
                        (ValidationHelpers.isPositiveInteger(child_id))
                )
                {
                    result = ResourcePersister.addParent(Integer.parseInt(child_id), parent.getDBID());
