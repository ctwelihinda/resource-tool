 ...
 * @author peter
 */
public class AddLongTextToResource extends HttpServlet {
    ...
    // ######### AUTHENTICATION ###############
        ...
        try
        {
            ...
            else
            {
                ...
                String the_text = "'" + request.getParameter("resource_text") + "'";
                String type = "'" + request.getParameter("text_type") + "'";

                boolean success = ResourceTextPersister.addTextToResource(Integer.parseInt(resource_id), the_text, type);
