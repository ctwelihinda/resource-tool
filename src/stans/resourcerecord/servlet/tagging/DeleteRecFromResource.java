...
import stans.resourcerecord.dao.RecommendationPersister;
 ...
 * @author peter
 */
public class DeleteRecFromResource extends HttpServlet {
    ...
    // ######### AUTHENTICATION ###############
        ...
        try
        {
            ...
            {
                String rec_id_string = request.getParameter("rec_id");
                if ((rec_id_string != null) && (ValidationHelpers.isPositiveInteger(rec_id_string)))
                {
                    Integer recommendation_id = Integer.parseInt(rec_id_string);
                    RecommendationPersister.delete(recommendation_id);
                }
            }
        }
        catch (Exception e)
