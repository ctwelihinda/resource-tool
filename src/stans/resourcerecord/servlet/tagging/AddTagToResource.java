 ...
 * @author peter
 */
public class AddTagToResource extends HttpServlet {
        ...
        try
        {
            ...
            else
            {
                ...
                )
                {
                    ...
                    if (parent_id == null)
                    { joinID = JoinPersister.addResourceTagJoin(resource_id, tag_id); }
                    else
                    { joinID = JoinPersister.addResourceTagJoin(resource_id, tag_id, Integer.parseInt(parent_id)); }
