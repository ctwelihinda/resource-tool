 ...
 * @author peter
 */
public class CreateAndAddNewTagToResource extends HttpServlet {
        ...
        try
        {
            ...
            else
            {
                ...
                if (tagtype_ids.size() > 0)
                {
                    ...
                    Integer joinID = JoinPersister.addResourceTagJoin(Integer.parseInt(resource_id), new_tag.getDBID());
