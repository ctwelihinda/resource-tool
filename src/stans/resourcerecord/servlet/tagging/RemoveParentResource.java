 ...
 * @author peter
 */
public class RemoveParentResource extends HttpServlet {
    ...
    // ######### AUTHENTICATION ###############
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    result = ResourcePersister.removeParent(Integer.parseInt(child_id));

                    sb.append("success - parent removed from ");
                    sb.append(child_id);
                }
                else
                {
