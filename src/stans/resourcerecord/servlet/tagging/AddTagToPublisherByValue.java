 ...
 * @author peter
 */
public class AddTagToPublisherByValue extends HttpServlet {
    ...
    // ######### AUTHENTICATION ###############
        ...
        System.out.println("Hello from AddTagToPublisherByVal!");
        try
        {
            ...
            else
            {
                ...
                if (resource_id != null)
                {
                    ...
                    if (!search_results.isEmpty())
                    {
                        ...
                        if (parent_id == null)
                        { joinID = JoinPersister.addPublisherTagJoin(Integer.parseInt(resource_id), tag_id); }
