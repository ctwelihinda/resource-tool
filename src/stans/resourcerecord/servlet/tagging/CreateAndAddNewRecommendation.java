 ...
 * @author peter
 */
public class CreateAndAddNewRecommendation extends HttpServlet {
    ...
    // ######### AUTHENTICATION ###############
        ...
        try
        {
            ...
            else
            {
                ...
                RecommendationPersister.createNew(Integer.parseInt(resource_id), Integer.parseInt(recommended), comments);
            }
        }
        catch (Exception e)
        {
