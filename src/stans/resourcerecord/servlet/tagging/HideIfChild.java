 ...
 * @author peter
 */
public class HideIfChild extends HttpServlet {
    ...
    // ######### AUTHENTICATION ###############
        ...
        try
        {
            if (permissions.getPermissionLevel("outofprint") >= TaggerPermissionsManager.READ_WRITE)
            {
                ...
                String hic_value = request.getParameter("hic_value");

                if ((ValidationHelpers.isPositiveInteger(resource_id)) && (ValidationHelpers.isWholeNumber(hic_value)))
                {
                    if (ResourcePersister.hideIfChild(Integer.parseInt(resource_id), Integer.parseInt(hic_value)))
                    {
                        sb.append("HideIfChild: resource ");
                        sb.append(resource_id);
                        sb.append(" now has an HIC value of ");
                        sb.append(hic_value);
                    }
                    else
                    {
                        sb.append("HideIfChild: ERROR - ResourcePersister.hideIfChild failed\n");
                        sb.append("--resource_id: ");
                        sb.append(resource_id);
                        sb.append("\n");
                        sb.append("--hic_value: ");
                ...
                {
                    sb.append("HideIfChild: ERROR - numeric validation error\n");
                    sb.append("--resource_id: ");
                    sb.append(resource_id);
                    sb.append("\n");
                    sb.append("--hic_value: ");
            ...
            {
                sb.append("HideIfChild: ERROR - user does not have the proper roles\n");
