 ...
 * @author peter
 */
public class AddInfoToTag extends HttpServlet {
    ...
    // ######### AUTHENTICATION ###############
        ...
        try
        {
            ...
            else
            {
                ...
                String tag_info = "'" + request.getParameter("tag_info") + "'";

                Tag the_tag = new Tag(Integer.parseInt(tag_id));
                the_tag.setInfo(tag_info);               

                sb.append("Info updated");
