 ...
 * @author peter
 */
public class DeleteTextFromResource extends HttpServlet {
    ...
    // ######### AUTHENTICATION ###############
        ...
        try
        {
            ...
            {
                String text_id_string = request.getParameter("text_id");
                
                if ((text_id_string != null) && (ValidationHelpers.isPositiveInteger(text_id_string)))
                {
                    Integer text_id = Integer.parseInt(text_id_string);
                    ...
                    if (type.equals("Annotation"))
                    {
                        ...
                        Query.update("moe_resource", "quick_description", resource_id, "''");
                    }
                    
                    ResourceTextPersister.delete(text_id);
                }
            }
        }
        catch (Exception e)
