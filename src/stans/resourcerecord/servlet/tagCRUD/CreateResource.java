    ...
    // ######### AUTHENTICATION ###############
        ...
        try
        {
            ...
            else
            {
                ...
                Resource new_res = ResourcePersister.createNew();

                if (new_res != null)
                {
                    int pk1 = new_res.getDBID();
                    //System.out.println("The pk1 of the new Resource is " + Integer.toString(pk1));
                    status_msg = "New resource successfully created<br/>The R Number is: " + new_res.getRNumber();
                    dispatch_url = "/webapps/moe-resource_tool_final-BBLEARN/EditResource?resource_number=" + new_res.getRNumber();
