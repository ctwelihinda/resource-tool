 ...
 * @author peter
 */
public class GetResourcePopupContent extends HttpServlet {
                ...
                for (Tag t : this_res_tags)
                {
                    ...
                    if (t.getType().equals("Tag Group"))
                    {
                        ...
                        subj_grade_sb.append("<div class=\\\"resource_table\\\">");
                            ...
                            {subj_grade_sb.append("<tr><th></th> <th>M</th> <th>1</th> <th>2</th> <th>3</th> <th>4</th> <th>5</th> <th>6</th> <th>7</th> <th>8</th> <th>9</th> <th>10</th> <th>20</th> <th>30</th> </tr>");}
                            else 
...
// END OF BIG ALL TAGS LOOP
                ...
                // ANNOTATION AND NOTES
                    ...
                    for (ResourceText rt : ResourceTextLoader.loadByResourceID(the_resource.getDBID()))
                    {
                        ...
                        {
                            notes = rt.getText().replace("\n", "<br /><br />").replace("\"", "\\\""); // want to have notes after the annotation, so save it here and append it after the loop
                            notes = notes + "<br /><br />";
                        }                        
                    ...
                    if (!notes.equals(""))
                    {
                        output_sb.append("<span class=\\\"resource_field_title\\\">Note:</span><br />");
                ...
                // LENGTH / RUNNING TIME
                    ...
                    )
                    {
                        ...
                        output_sb.append("<span class=\\\"resource_field_title\\\" id=\\\"length_field_title\\\">");
                            output_sb.append(LanguageHelpers.getTranslation("Length", display_language, null));
                            output_sb.append(" / ");
                            output_sb.append(LanguageHelpers.getTranslation("Running Time", display_language, null));
                        output_sb.append(": </span>");
				...
				test_sb.append( "<div class=\\\"test_class\\\">" );
				test_sb.append( "Testing:1<br />Testing:'2'<br/>Testing: http://rover.edonline.sk.ca/assets/screenshot_missing.png" );
				test_sb.append( "</div>" );
    ...
    // PRINT IT!!!
				out.println("jsonCallback(");
                    out.println("{");
						out.print("\"resource_content\": \"");
							out.print( output_sb.toString() );
							//out.print( test_sb.toString() );
						out.print("\"");
                    out.println("}");
                out.println(");");
