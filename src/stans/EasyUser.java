...
public class EasyUser {
    ...
    public EasyUser(User blackboarduser) {
        blackboard = blackboarduser;
        shortcuts = new ShortcutMethods();

    }

    public EasyUser(HttpServletRequest request) {
    ...
    public EasyUser(Context bbContext) {
        blackboard = bbContext.getUser();
        shortcuts = new ShortcutMethods();

    }

    public EasyUser(String username) throws KeyNotFoundException, PersistenceException {
