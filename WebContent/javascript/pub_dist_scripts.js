function add_tag (new_or_existing, form_element, result_element) {
    ...
    var servlet_name = "AddTagToPublisher";
    if (new_or_existing == "new")
    { servlet_name = "CreateAndAddNewTagToPublisher"; }
    if (new_or_existing == "by value")
    { servlet_name = "AddTagToPublisherByValue"; }
    ...
    // people
        $('#add_people_tag_submit').on('click', function() {
            add_tag ("by value", $("#add_people_tag_id"), $("#people_tags tbody"));
        });
